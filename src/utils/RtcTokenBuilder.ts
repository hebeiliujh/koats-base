...
export class RtcTokenBuilder {
   ...
   */
  static buildTokenWithUid(appID: any, appCertificate: any, channelName: any, uid: any, role: any, privilegeExpiredTs: any) {
   ...
   * @return The new Token.
   */
  static buildTokenWithAccount(appID: string, appCertificate: string, channelName: string, account: string | number, role: number, privilegeExpiredTs: any) {
